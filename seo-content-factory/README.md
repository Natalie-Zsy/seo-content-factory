...
- 🔗 竞品外链：反查竞品的**高质量外链来源**（来源域名权重 / 锚文本 / DoFollow 筛选），模仿其外链策略
...
### 🔗 竞品外链透视镜
1. 输入竞品域名或页面（如 example.com）
2. 按需勾选「仅看 DoFollow 链接」「每个域名仅限一条」，设置返回条数
3. 点「🚀 开始透视竞品外链」→ 看到外链总数 / 高权重来源 / 详细列表（来源域名权重 / 来源页面 / 锚文本 / 目标页面 / 属性）
4. 点「📥 导出数据为 CSV」保存结果
